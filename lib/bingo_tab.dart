...
class BingoTab extends StatefulWidget {
  BingoTab({Key key}) : super(key: key);

  @override
  _BingoState createState() => _BingoState();
}

class _BingoState extends State<BingoTab> with SingleTickerProviderStateMixin {
                                                                          ...
                                                                          return index !=
                                                                              ...
                                                                              ? GestureDetector(
                                                                                  onTap: () {
                                                                                    started1++;
                                                                                    setState(() {
                                                                                      touchedBox2(touchIndex: index, box: 2);
                                                                                    });
